// ====================================================================
//  mg.js — 咪咕搜索（LX 原样移植）
//  来源：lx-music-mobile src/utils/musicSdk/mg/musicSearch.js（Apache-2.0）
//  仅把 ESM 导入换成 CommonJS require，搜索逻辑与字段映射未做改动。
// ====================================================================
'use strict';

const { httpFetch } = require('../http');
const { sizeFormate, formatPlayTime } = require('../format');
const { toMD5, formatSingerName } = require('../format');
